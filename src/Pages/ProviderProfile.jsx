...
import ProviderViewServices from "../Compononts/ProviderViewServices"
            ...
            <div className="profile">
                <div className="profile-container">
                        ...
                        <div className="profile-sidebar-container">
                            ...
                            <div className="profile-side-nav">
                                <div className="profile-side-nav-links">
                                    ...
                                    <div onClick={() => { setShowMain("my-services") }} className={`${showMain == "my-services" ? "nav-link visible-link" : "nav-link"}`}>
                                        <h5>My Services</h5>
                                    </div>
                    ...
                    <div className="profile-main">
                        ...
                        {
                            showMain == "my-orders" && <ProviderViewOrders />
                        }
                        {
                            showMain == "my-services" && <ProviderViewServices />
                        }
